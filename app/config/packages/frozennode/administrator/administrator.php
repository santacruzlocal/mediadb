...
return array(
	 ...
	 */
	'menu' => array(
			'Movies & Series' => array('movies', 'series'),
			'actors',
			'directors',
			'writers',
			'users',
			'groups',
			'news',
			'Settings' => array('settings.options', 'settings.backgrounds', 'settings.appearance', 'settings.ads'),
		),
	 ...
	 * @type string
	 */
	'dashboard_view' => 'Dashboard.Master',
