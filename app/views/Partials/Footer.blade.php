              ...
              <div class="row">
                  <div class="span12 footer-col footer-sub">
                      <div class="row no-margin">
                          <div class="span6"><span class="left">{{ trans('home.copyright') }} {{ trans('home.copy') }} <a href="">{{ trans('home.brand') }}</a> {{ trans('home.reserved') }}</span></div>
                          <div class="span6">
                            <span class="right">
                            <a href="">Home</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="{{ route('tos') }}">{{ trans('home.tos') }}</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="{{ route('privacy') }}">{{ trans('home.privacy') }}</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="#">{{ trans('home.help') }}</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="{{ route('contact') }}">{{ trans('main.contact') }}</a>
                            </span>
                          </div>
                      </div>
                  </div>
